...
models = [GaussianMixture(n, covariance_type='full', random_state=5).fit(X) for n in n_components]
...
n_components = np.arange(2, 9)
models = [GaussianMixture(n, covariance_type='full', random_state=1).fit(X) for n in n_components]
...
n_components = np.arange(2, 9)
models = [GaussianMixture(n, covariance_type='full', random_state=6).fit(X) for n in n_components]
